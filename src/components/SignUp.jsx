...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(!pwdRegex.test(pwd)){
            setErrorMsg(`The password must include a digit, a lowercase and uppercase charcter and a special charcter`);
            return;
        }
                            ...
                            <form className="absolute top-[208px] left-[84px] w-[323px] h-[118px]  flex flex-col justify-center items-center gap-6" onSubmit={handleVerifyOtp}>
                                ...
                                <p className="text-sm">
                                    ...
                                    {isResendDisabled ? (
                                        ...
                                        <button className="text-blue-700 hover:text-blue-900 text-sm" onClick={handleSubmit}>
                                            Resend OTP
                                        </button>
                                    )}
                                </p>
                         ...
                         focus:outline-none focus:ring-0 text-xs pl-4 pr-4 p-2  ${(errorMsg === "Invalid email") || (errorMsg === "Enter all fields" && !email) ? 'border-red-500  placeholder-red-500 text-red-500' : 'border-gray-500  placeholder-gray-500'}`}
                                        ...
                                        <div className="relative w-full">
                                            <input
                                                ...
                                                maxLength={12}
                                                className={`w-full border-b transition duration-200 
                        focus:outline-none focus:ring-0 text-xs pl-4 pr-4 p-2 ${(errorMsg === "Enter all fields" && !pwd) ||(errorMsg==='The password must include a digit, a lowercase and uppercase charcter and a special charcter')? 'border-red-500  placeholder-red-500 text-red-500' : 'border-gray-500 placeholder-gray-500'}`}
                                            />
                                            <span
