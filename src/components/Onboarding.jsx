...
const Onboarding = () => {
    ...
    return (
        ...
        <div className="flex justify-between h-screen overflow-hidden items-center">
            ...
            <button className="w-[195px] h-[40px] px-[24px] py-[10px] font-semibold rounded-[8px] text-white bg-[#5663AC] opacity-100 hover:bg-[#4a5b9b] transition duration-200" onClick={() => navigate("/login")}>
                Log In
                </button>
