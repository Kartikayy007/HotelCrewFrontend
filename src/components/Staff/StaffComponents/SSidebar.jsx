...
const SSidebar = ({ onMenuItemClick }) => {
    ...
    const menuItems = [
        ...
        { icon: <ClipboardCheck size={20} />, label: 'Task', component: 'STask' },
        { icon: <CalendarClock size={20} />, label: 'Schedule ', component: 'SSchedule' },
        { icon: <Settings size={20} />, label: 'My Profile', component: 'SProfile' },
