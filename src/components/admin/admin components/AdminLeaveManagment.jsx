...
import { Modal, Box, Typography, Divider, Button, useMediaQuery, useTheme, Snackbar, Alert } from '@mui/material';
...
const AdminLeaveManagement = () => {
    ...
    return (
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            {filteredRequests.map(request => (
              <tr key={request.id} className="border-b hover:bg-[#F1F6FC]/50 transition-colors">
                <td className="p-3 text-base font-medium cursor-pointer hover:text-blue-600" onClick={() => handleOpenModal(request)}>
                  {request.name}
                </td>
  ...
  return (
    <section className="bg-[#E6EEF9] h-full w-full overflow-scroll p-1 xs:p-2 sm:p-4">
      ...
      <div className={`bg-white ${isMobile ? 'rounded-lg shadow-md' : 'h-[83vh] overflow-scroll rounded-lg shadow-lg'} p-4 sm:p-6`}>
      ...
      <Modal open={openModal} onClose={handleCloseModal} aria-labelledby="staff-profile-modal">
        <Box sx={modalStyle}>
          <div className="flex flex-col">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <Typography variant="body1">{selectedStaff?.description}</Typography>
              </div>
              <div>
                <Typography variant="subtitle2" color="text.secondary">
                ...
                <div className="flex items-center space-x-4 mt-2">
                  <Button
                    variant="contained"
                    color={selectedAction === 'approved' ? 'success' : 'inherit'}
                    size="small"
              ...
              <div>
                ...
                <Typography variant="body1">
                  {selectedStaff?.startDate} to {selectedStaff?.endDate} ({selectedStaff?.days} days)
                </Typography>
              </div>
            </div>
          </div>
